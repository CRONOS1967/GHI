...
--
-- Host: localhost
-- Generation Time: Jul 25, 2021 at 09:45 AM
...
('CU17', '2020-06-03', 'Teacher', 987654321, 3, '2019-07-11', 17),
('CU24', '2015-05-15', 'Day worker', 987653433, 5, '2021-03-12', 24),
...
(4, 'Binyam', 'Binyam', 'Yirdaw', 'Bahir dar', 987654321, 'bini@gmail.com', 'cord', 'Male', 'Screenshot from 2021-07-11 10-26-17.png', '$2y$10$XqL5uXBwt1nxf7zqOriTX.TukF0b9e6aKgEDe3UPyYsGjyZnurscq'),
...
(24, 'Amanulae.Gos', 'Amanulae', 'Goshu', 'Gondar', 987653433, 'aman@gmail.com', 'Cust', 'Male', 'about.jpg', '$2y$10$4EX0P5bizMOtHFtp46rKq.ghFaoJd0cDLtzMCIb9128EyeESxdUtC'),
...
--
ALTER TABLE `Patients`
  MODIFY `idPatients` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `Families`
  ADD CONSTRAINT `fk_Families_Customers1` FOREIGN KEY (`idC`) REFERENCES `Customers` (`idC`) ON DELETE NO ACTION ON UPDATE CASCADE;
