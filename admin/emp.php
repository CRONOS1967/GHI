                ...
                <div class="container">
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            $obj = new Backend;
                            $conn = $obj->connection();
                            $sql = "SELECT * FROM Users join Employees on Users.idUsers = Employees.idUsers WHERE Role != 'cus'";
                            $query = mysqli_query($conn, $sql) or die(mysqli_error($conn));

                            ?>
                            <div class="module">
                                <div class="module-head">
                                    <h3>Employees DataTables</h3>
                                </div>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
                                        ...
                                        <tbody>
                                            <?php while ($res = mysqli_fetch_assoc($query)) : ?>
                                                <tr class="odd gradeX">
                                                    <td><?php echo $res['idE']; ?></td>
                                                    <td><?php echo $res['Fname'] . " " . $res['Lname']; ?></td>
                                                    <td><?php echo $res['Email']; ?></td>
                                                    <td class="center"> <?php echo $res['Phone']; ?></td>
                                                    <td class="center"><?php echo $res['Role']; ?></td>
